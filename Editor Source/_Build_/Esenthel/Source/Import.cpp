...
ImporterClass::Import::MaterialEx::MaterialEx() : base_0_id(UIDZero), base_1_id(UIDZero), base_2_id(UIDZero), detail_id(UIDZero), macro_id(UIDZero), light_id(UIDZero), adjust_params(true), textures(TEXF_NONE) {}
