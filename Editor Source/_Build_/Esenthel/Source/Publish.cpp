...
bool InitPublish()
{
   ...
   PublishPVRTCQualityTextStyle.reset().align.set(0, 1); PublishPVRTCQualityTextStyle.size=0.055f;
   ...
   Gui+=PublishPVRTCQuality    .create(Rect_C(0, -0.40f, 0.45f, 0.06f), PVRTCQuality, Elms(PVRTCQuality)).set(GetPVRTCQuality(), QUIET).func(PVRTCQualityChanged).focusable(false);
...
Texture::Texture() : src_tex_id(UIDZero), uses_alpha(false), keep_hq(false), mtrl_base_1(false), regenerate(false), downsize(0) {}
