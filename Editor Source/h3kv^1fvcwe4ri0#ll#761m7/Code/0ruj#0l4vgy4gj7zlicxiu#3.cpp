...
void ExtractWaterBaseTextures(C Project &proj, C UID &base_0, C UID &base_1, C UID &base_2, Image *col, Image *alpha, Image *bump, Image *normal, Image *smooth, Image *reflect, Image *glow, C VecI2 &size=-1)
...
void SetTransform(MemPtr<Edit.FileParams> files, C Str &name, C Str &value=S) // this ignores partial(non full size) transforms 
{
