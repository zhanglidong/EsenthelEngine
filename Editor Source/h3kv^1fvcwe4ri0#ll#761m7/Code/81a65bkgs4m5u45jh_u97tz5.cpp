...
class ProjectEx : ProjectHierarchy
{
   ...
   static void MtrlRGBCur              (ProjectEx &proj) {if(MtrlEdit.elm)proj.mtrlRGB            (proj.menu_list_sel, MtrlEdit.edit.color.xyz);else Gui.msgBox(S, "There's no Material opened");}
