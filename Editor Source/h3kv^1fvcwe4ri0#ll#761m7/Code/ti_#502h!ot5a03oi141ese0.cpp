...
class MergeSimilarMaterials : PropWin
{
   ...
   bool     name=false, color_name=false, color_is=false, color_tex=true, normal_tex=true, base2_tex=true, detail_tex=true, macro_tex=true, light_tex=true, tech=true, cull=true;
