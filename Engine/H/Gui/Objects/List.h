...
//{
  ...
  _List&     imageSize(C Vec2 &base, Flt relative, C Rect &padding=Vec2(0)); C Vec2&   imageSizeBase   ()C {return                  _image_base;} // set/get image    base     size    ,        0..Inf     , default=(0.0  , 0.1/64), final text  size = "zoom * (image.size * imageSizeRel() + imageSizeBase())", 'padding'=padding applied to the whole element rectangle
