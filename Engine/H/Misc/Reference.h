...
T1(TYPE) struct Reference // Reference, this is a pointer to an object which may be deleted but its memory is still accessible and possibly occupied by another object of similar class
{
   ...
   TYPE* validPtr  ()C {return   valid() ? _object : null           ;} // return pointer   to object that is valid, and null if invalid
   TYPE*   anyPtr  ()C {return             _object                  ;} // return pointer   to object without checking if it's valid
 C UID & objectID  ()C {return  _object_id                          ;} // return              object ID
   TYPE& operator()()C {return *_object                             ;} // return reference to object, usage of this method must be preceded by performing reference validation using 'valid' method
   TYPE* operator->()C {return  _object                             ;} // return reference to object, usage of this method must be preceded by performing reference validation using 'valid' method
