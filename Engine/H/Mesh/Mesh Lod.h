...
struct MeshLod // Level of Detail, array of Mesh Part's
{
   ...
   MeshLod& setNormalsAuto(Flt angle=PI_3, Flt pos_eps=EPS); // recalculate vertex            3D normals using an automatic smart algorithm, 'angle'=angle limit for merging vertex normals
