...
void ClipPoly (C MemPtr<VecD2  > &poly, C PlaneD2 &plane, MemPtr<VecD2  > output                                          ); // clip  'poly' according to 'plane' and store result  in 'output'  , 'poly' and 'output'   must point to different containers
