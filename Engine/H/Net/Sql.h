...
struct SQL
{
   ...
   // commands
      ...
      Bool    setRow (C Str &table_name, C Str &id_name, C Str &id_value, C SQLValues &values, Str *messages=null, Int *error=null); // set    existing row  in 'table_name' table or create new if not found with given row 'values', false on fail
      Bool    setRow (C Str &table_name, C Str &id_name, C UID &id_value, C SQLValues &values, Str *messages=null, Int *error=null); // set    existing row  in 'table_name' table or create new if not found with given row 'values', false on fail
   #if EE_PRIVATE
      Bool   _setRow (C Str &table_name, C Str &id_name, C Str &id_value, C SQLValues &values, Str *messages, Int *error); // set    existing row  in 'table_name' table or create new if not found with given row 'values', false on fail
   #endif
