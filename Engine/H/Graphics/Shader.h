...
{
   Byte skin, materials, textures, bump_mode, alpha_test, light_map, detail, color, mtrl_blend, heightmap, fx, per_pixel, tesselate;
...
{
   Byte skin, color, textures, bump_mode, alpha_test, alpha, light_map, fx, per_pixel;
