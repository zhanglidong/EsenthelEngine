 ...
 C Str8&        deviceName     ()C {return _device_name   ;} // get GPU device name
   ...
   void     setColorLUT      (                             );
                                                      ...
                                                      constexpr Bool             signedVelRT       ()C {return DX11            ;} // if Velocity Render Target is signed #SIGNED_VEL_RT
                                                                ...
                                                                Bool             colorManagedActual()C {return _color_lut.is() ;} // if need to perform any color transformations
#endif
   ...
   Display& colorManaged     (Bool             managed     );   Bool             colorManaged      ()C {return _color_managed  ;} // get/set if App should be color managed         (true/false                         , default=            false                             ), enabling makes application use the installed monitor color profile in the system, Warning: this slows down performance
