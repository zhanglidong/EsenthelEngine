...
struct Display : DisplayState, DisplayDraw // Display Control
{
 ...
 C Str8&        deviceName     ()C {return _device_name   ;} // get GPU device name
   ...
   Display& reflectAllow     (Bool             allow       );   Bool             reflectAllow      ()C {return _reflect_allow  ;} // set/get Allow Reflections                      (true/false                         , default=             true (false           for Mobile))
...
private:
   ...
   Bool              _full, _sync, _exclusive, _hp_col_rt, _hp_nrm_rt, _hp_lum_rt, _dither, _bend_leafs, _particles_soft, _particles_smooth, _tex_mip_filter, _tex_macro, _tex_detail_lod, _eye_adapt, _bloom_sat, _bloom_max, _bloom_half, _bloom_samples,
                     ...
                     _bloom_allow, _glow_allow, _reflect_allow, _ao_all, _amb_jitter, _amb_normal, _shd_jitter, _shd_reduce, _grass_shadow, _grass_mirror, _vol_light, _vol_add, _dof_foc_mode, _color_palette_allow,
