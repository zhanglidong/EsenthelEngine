...
struct DisplayClass : DisplayState, DisplayDraw // Display Control
{
 ...
 C Str8&        deviceName     ()C {return _device_name   ;} // get GPU device name
   ...
   DisplayClass& sharpenIntensity (Flt              intensity   );   Flt              sharpenIntensity  ()C {return _sharpen_intensity;} // get/set Rendering Sharpening Intensity         (0..1                               , default=              0.5                             ), the change is instant, you can call it real-time
