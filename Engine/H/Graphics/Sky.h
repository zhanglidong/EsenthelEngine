...
struct SkyClass
{
   ...
   // atmospheric sky
#if EE_PRIVATE
   Vec4 atmosphericHorizonColorL()C {return SRGBToLinear(_hor_col_s);}
   Vec4 atmosphericSkyColorL    ()C {return SRGBToLinear(_sky_col_s);}
#endif
   ...
   SkyClass& atmosphericHorizonColor    (C Vec4     &color_s  );   Vec4      atmosphericHorizonColor    ()C {return _hor_col_s;} // set/get horizon color sRGB gamma,    (0,0,0,0)..(1,1,1,1)           , default=(0.32, 0.46, 0.58, 1.0) here alpha specifies opacity to combine with star map when used
   SkyClass& atmosphericSkyColor        (C Vec4     &color_s  );   Vec4      atmosphericSkyColor        ()C {return _sky_col_s;} // set/get sky     color sRGB gamma,    (0,0,0,0)..(1,1,1,1)           , default=(0.16, 0.36, 0.54, 1.0) here alpha specifies opacity to combine with star map when used
