...
struct SkyClass
{
   ...
   SkyClass& atmosphericHorizonColor    (C Vec4     &color    );   Vec4      atmosphericHorizonColor    ()C {return _hor_col_s;} // set/get horizon color sRGB gamma,    (0,0,0,0)..(1,1,1,1)           , default=(0.32, 0.46, 0.58, 1.0) here alpha specifies opacity to combine with star map when used
   SkyClass& atmosphericSkyColor        (C Vec4     &color    );   Vec4      atmosphericSkyColor        ()C {return _sky_col_s;} // set/get sky     color sRGB gamma,    (0,0,0,0)..(1,1,1,1)           , default=(0.16, 0.36, 0.54, 1.0) here alpha specifies opacity to combine with star map when used
