...
struct SkyClass
{
   ...
   SkyClass& atmosphericHorizonColorS   (C Vec4     &color_s  );   Vec4      atmosphericHorizonColorS   ()C;                     // set/get horizon color sRGB   gamma,    (0,0,0,0)..(1,1,1,1)           , default=(0.32, 0.46, 0.58, 1.0) here alpha specifies opacity to combine with star map when used
   ...
   SkyClass& atmosphericSkyColorS       (C Vec4     &color_s  );   Vec4      atmosphericSkyColorS       ()C;                     // set/get sky     color sRGB   gamma,    (0,0,0,0)..(1,1,1,1)           , default=(0.16, 0.36, 0.54, 1.0) here alpha specifies opacity to combine with star map when used
