...
namespace Edit{
/******************************************************************************/
#define EI_VER 48 // this needs to be increased every time a new command is added, existing one is changed, or some of engine class file formats get updated
...
{
   f.cmpUIntV(0);
   f<<technique<<tex_quality<<cull<<flip_normal_y<<smooth_is_rough<<downsize_tex_mobile<<color_s<<emissive_s<<emissive_glow<<smooth<<reflect_min<<reflect_max<<glow<<normal<<bump<<uv_scale
