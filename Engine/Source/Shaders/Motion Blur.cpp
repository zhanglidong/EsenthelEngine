...
VecH4 Convert_PS(NOPERSP Vec2 uv:UV):TARGET
{
 ...
 //if(all(Abs(motion.x)*2    <ImgSize.xy)         )motion=0; // motions less than 0.5 pixel size force to 0 (ignore this code because this is done faster by just setting initial value of 'length2.x')
   return motion;
}
/******************************************************************************/
