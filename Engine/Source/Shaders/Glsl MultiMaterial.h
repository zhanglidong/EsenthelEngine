...
{
   MP Vec4 _color, _normal_mul, _normal_add;
...
MP Vec4 MultiMaterial0Color   () {return MultiMaterial0._color;}
MP Vec  MultiMaterial0Color3  () {return MultiMaterial0._color.rgb;}
HP Flt  MultiMaterial0TexScale() {return MultiMaterial0._texscale_detscale_detmul_detadd.x;}

MP Vec4 MultiMaterial1Color   () {return MultiMaterial1._color;}
MP Vec  MultiMaterial1Color3  () {return MultiMaterial1._color.rgb;}
HP Flt  MultiMaterial1TexScale() {return MultiMaterial1._texscale_detscale_detmul_detadd.x;}

MP Vec4 MultiMaterial2Color   () {return MultiMaterial2._color;}
MP Vec  MultiMaterial2Color3  () {return MultiMaterial2._color.rgb;}
HP Flt  MultiMaterial2TexScale() {return MultiMaterial2._texscale_detscale_detmul_detadd.x;}

MP Vec4 MultiMaterial3Color   () {return MultiMaterial3._color;}
MP Vec  MultiMaterial3Color3  () {return MultiMaterial3._color.rgb;}
