...
static Int  EmissiveMode(C Material &material) {return (material.emissive_l.max()>EPS_COL8_NATIVE || material.emissive_glow>EPS_COL8) ? material.emissive_map ? 2 : 1 : 0;}
