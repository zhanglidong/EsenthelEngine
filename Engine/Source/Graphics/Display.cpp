...
Display& Display::envMap  (C ImagePtr &cube ) {if(_env_map  !=cube ){Bool was=_env_map; Sh.Env     ->set((_env_map  =cube)()); if(was!=_env_map)setShader();} return T;} // if changed map presence then reset shader
/******************************************************************************/
