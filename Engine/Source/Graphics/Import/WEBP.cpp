...
Bool Image::ExportWEBP(File &f, Flt rgb_quality, Flt alpha_quality)C
{
 ...
 C Image *src=this;
   ...
   if(src->hwType()!=IMAGE_B8G8R8A8 && src->hwType()!=IMAGE_B8G8R8A8_SRGB)if(src->copyTry ( temp, -1, -1, -1, IMAGE_B8G8R8A8, IMAGE_SOFT, 1))src=&temp;else return false; // WEBP uses BGRA
