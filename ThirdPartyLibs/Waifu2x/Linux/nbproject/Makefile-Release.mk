...
${OBJECTDIR}/_ext/a59f760b/Buffer.o: ../lib/src/Buffer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/Buffer.o ../lib/src/Buffer.cpp

${OBJECTDIR}/_ext/a59f760b/common.o: ../lib/src/common.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a59f760b
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/common.o ../lib/src/common.cpp

${OBJECTDIR}/_ext/a59f760b/convertRoutine.o: ../lib/src/convertRoutine.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a59f760b
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/convertRoutine.o ../lib/src/convertRoutine.cpp

${OBJECTDIR}/_ext/a59f760b/cvwrap.o: ../lib/src/cvwrap.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a59f760b
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/cvwrap.o ../lib/src/cvwrap.cpp

${OBJECTDIR}/_ext/a59f760b/modelHandler.o: ../lib/src/modelHandler.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a59f760b
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/modelHandler.o ../lib/src/modelHandler.cpp

${OBJECTDIR}/_ext/a59f760b/modelHandler_avx.o: ../lib/src/modelHandler_avx.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a59f760b
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/modelHandler_avx.o ../lib/src/modelHandler_avx.cpp

${OBJECTDIR}/_ext/a59f760b/modelHandler_fma.o: ../lib/src/modelHandler_fma.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a59f760b
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/modelHandler_fma.o ../lib/src/modelHandler_fma.cpp

${OBJECTDIR}/_ext/a59f760b/modelHandler_sse.o: ../lib/src/modelHandler_sse.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a59f760b
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/modelHandler_sse.o ../lib/src/modelHandler_sse.cpp

${OBJECTDIR}/_ext/a59f760b/w2xconv.o: ../lib/src/w2xconv.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a59f760b
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a59f760b/w2xconv.o ../lib/src/w2xconv.cpp
